...
def analyze_dex(dex_path, output_file):
    ...
    target_strings = ["YellowRose", "yellowRose", "RosePropose"]
    ...
    with open(output_file, "a") as out:
        for d_obj in d_list:
            ...
            for cls in classes:
                ...
                if any(s in class_name for s in target_strings):
                    found_count += 1
...
if __name__ == "__main__":
    output_path = "decompiled_rose_logic.java"
    if os.path.exists(output_path):
        os.remove(output_path)

    dex_files = ["base/classes2.dex", "base/classes3.dex"]
